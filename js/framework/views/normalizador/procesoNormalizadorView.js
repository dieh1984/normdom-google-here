define([
   ...
   var NormalizadorListado = Backbone.View.extend({
        ...
        render: function(){
            ...
            $.get('/diy/file/resultado_merlin_1000.txt', function(data){
                ...
                $.get('/diy/file/listado_nuevo_10.txt', function(data){
                    var lines = data.split("\n");
                    var times = 1500;
            ...
            if(column[y] != ""){
                ...
                if(direccionAux != direccion){
                    ...
                    var platform = new H.service.Platform({
                      'app_id': 'k86aL0eimTNNhd1m7B8a',
                      'app_code': '11pyO6Yq3Zb3dUO97U4stg'
                    });
                    console.log("listoo!");
